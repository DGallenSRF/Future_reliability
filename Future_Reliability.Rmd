...
ff <- ggplot()+
  geom_point(data = data.frame(Rel_bin[Rel_bin$Segment == 1,]),aes(x=Density_bin,y=Flow, color=quantiles))+
  geom_abline(data = data.frame(Rel_FF[Rel_FF$Segment == 1,]), aes(slope = FF_quantile, intercept = 0, linetype = 'dashed', color = quantiles))+
...
ff <- ggplot()+
  geom_point(data = data.frame(Rel_bin[Rel_bin$Segment == 2,]),aes(x=Density_bin,y=Flow, color=quantiles))+
  geom_abline(data = data.frame(Rel_FF[Rel_FF$Segment == 2,]), aes(slope = FF_quantile, intercept = 0, linetype = 'dashed', color = quantiles))+
  facet_grid(~ Delay_type, scales = 'free')
ggplotly(ff)
```
...
ff <- ggplot()+
  geom_point(data = data.frame(Rel_bin[Rel_bin$Segment == 3,]),aes(x=Density_bin,y=Flow, color=quantiles))+
  geom_abline(data = data.frame(Rel_FF[Rel_FF$Segment == 3
                                       ,]), aes(slope = FF_quantile, intercept = 0, linetype = 'dashed', color = quantiles))+
  facet_grid(~ Delay_type, scales = 'free')
ggplotly(ff)
```
...
ff <- ggplot()+
  geom_point(data = data.frame(Rel_bin[Rel_bin$Segment == 4,]),aes(x=Density_bin,y=Flow, color=quantiles))+
  geom_abline(data = data.frame(Rel_FF[Rel_FF$Segment == 4,]), aes(slope = FF_quantile, intercept = 0, linetype = 'dashed', color = quantiles))+
  facet_grid(~ Delay_type, scales = 'free')
ggplotly(ff)
```
...
ff <- ggplot()+
  geom_point(data = data.frame(Rel_bin[Rel_bin$Segment == 5,]),aes(x=Density_bin,y=Flow, color=quantiles))+
  geom_abline(data = data.frame(Rel_FF[Rel_FF$Segment == 5,]), aes(slope = FF_quantile, intercept = 0, linetype = 'dashed', color = quantiles))+
  facet_grid(~ Delay_type, scales = 'free')
ggplotly(ff)
```
...
ff <- ggplot()+
  geom_point(data = data.frame(Rel_bin[Rel_bin$Segment == 6,]),aes(x=Density_bin,y=Flow, color=quantiles))+
  geom_abline(data = data.frame(Rel_FF[Rel_FF$Segment == 6,]), aes(slope = FF_quantile, intercept = 0, linetype = 'dashed', color = quantiles))+
  facet_grid(~ Delay_type, scales = 'free')
ggplotly(ff)
```
...
ff <- ggplot()+
  geom_point(data = data.frame(Rel_bin[Rel_bin$Segment == 7,]),aes(x=Density_bin,y=Flow, color=quantiles))+
  geom_abline(data = data.frame(Rel_FF[Rel_FF$Segment == 7,]), aes(slope = FF_quantile, intercept = 0, linetype = 'dashed', color = quantiles))+
  facet_grid(~ Delay_type, scales = 'free')
ggplotly(ff)
```
...
ff <- ggplot()+
  geom_point(data = data.frame(Rel_bin[Rel_bin$Segment == 8,]),aes(x=Density_bin,y=Flow, color=quantiles))+
  geom_abline(data = data.frame(Rel_FF[Rel_FF$Segment == 8,]), aes(slope = FF_quantile, intercept = 0, linetype = 'dashed', color = quantiles))+
  facet_grid(~ Delay_type, scales = 'free')
ggplotly(ff)
...
ff <- ggplot()+
  geom_point(data = data.frame(Rel_bin[Rel_bin$Segment == 9,]),aes(x=Density_bin,y=Flow, color=quantiles))+
  geom_abline(data = data.frame(Rel_FF[Rel_FF$Segment == 9,]), aes(slope = FF_quantile, intercept = 0, linetype = 'dashed', color = quantiles))+
  facet_grid(~ Delay_type, scales = 'free')
ggplotly(ff)
```
...
tt <- ggplot()+
  geom_point(data=Rel_bin[Rel_bin$Segment == 1,],aes(x= Density_bin,y = TT_quantile, color= quantiles))+
  geom_smooth(data=Rel_bin[Rel_bin$Segment == 1,],aes(x= Density_bin,y = TT_quantile, color= quantiles),span=1,se=F)+
  facet_grid(~Delay_type, scales = 'free')
...
tt <- ggplot()+
  geom_point(data=Rel_bin[Rel_bin$Segment == 2,],aes(x= Density_bin,y = TT_quantile, color= quantiles))+
  geom_smooth(data=Rel_bin[Rel_bin$Segment == 2,],aes(x= Density_bin,y = TT_quantile, color= quantiles),span=1,se=F)+
  facet_grid(~Delay_type, scales = 'free')
...
tt <- ggplot()+
  geom_point(data=Rel_bin[Rel_bin$Segment == 3,],aes(x= Density_bin,y = TT_quantile, color= quantiles))+
  geom_smooth(data=Rel_bin[Rel_bin$Segment == 3,],aes(x= Density_bin,y = TT_quantile, color= quantiles),span=1,se=F)+
  facet_grid(~Delay_type, scales = 'free')
...
tt <- ggplot()+
  geom_point(data=Rel_bin[Rel_bin$Segment == 4,],aes(x= Density_bin,y = TT_quantile, color= quantiles))+
  geom_smooth(data=Rel_bin[Rel_bin$Segment == 4,],aes(x= Density_bin,y = TT_quantile, color= quantiles),span=1,se=F)+
  facet_grid(~Delay_type, scales = 'free')
...
tt <- ggplot()+
  geom_point(data=Rel_bin[Rel_bin$Segment == 5,],aes(x= Density_bin,y = TT_quantile, color= quantiles))+
  geom_smooth(data=Rel_bin[Rel_bin$Segment == 5,],aes(x= Density_bin,y = TT_quantile, color= quantiles),span=1,se=F)+
  facet_grid(~Delay_type, scales = 'free')
...
tt <- ggplot()+
  geom_point(data=Rel_bin[Rel_bin$Segment == 6,],aes(x= Density_bin,y = TT_quantile, color= quantiles))+
  geom_smooth(data=Rel_bin[Rel_bin$Segment == 6,],aes(x= Density_bin,y = TT_quantile, color= quantiles),span=1,se=F)+
  facet_grid(~Delay_type, scales = 'free')
...
tt <- ggplot()+
  geom_point(data=Rel_bin[Rel_bin$Segment == 7,],aes(x= Density_bin,y = TT_quantile, color= quantiles))+
  geom_smooth(data=Rel_bin[Rel_bin$Segment == 7,],aes(x= Density_bin,y = TT_quantile, color= quantiles),span=1,se=F)+
  facet_grid(~Delay_type, scales = 'free')
...
tt <- ggplot()+
  geom_point(data=Rel_bin[Rel_bin$Segment == 8,],aes(x= Density_bin,y = TT_quantile, color= quantiles))+
  geom_smooth(data=Rel_bin[Rel_bin$Segment == 8,],aes(x= Density_bin,y = TT_quantile, color= quantiles),span=1,se=F)+
  facet_grid(~Delay_type, scales = 'free')
...
tt <- ggplot()+
  geom_point(data=Rel_bin[Rel_bin$Segment == 9,],aes(x= Density_bin,y = TT_quantile, color= quantiles))+
  geom_smooth(data=Rel_bin[Rel_bin$Segment == 9,],aes(x= Density_bin,y = TT_quantile, color= quantiles),span=1,se=F)+
  facet_grid(~Delay_type, scales = 'free')
...
tt <- ggplot(data=Rel[Rel$Segment == 1,],aes(x= Dens,y = Hourly_Flow, color= Quantiles, label = DateTime))+
  geom_point()+
...
```{r Density vs Flow bin seg1, fig.width = 11,echo = FALSE, message = FALSE}

tt <- ggplot(data=Rel_bin[Rel_bin$Segment == 1,],aes(x= Density_bin,y = Flow, color= quantiles))+
  geom_point()+
  # geom_smooth(span=0.75,se=F)+
  facet_grid(~Delay_type, scales = 'free')+
  scale_y_continuous(minor_breaks = seq(0, 4000,100), breaks = seq(0,4000,200))+
  ggtitle('Segment 1')
...
tt <- ggplot(data=Rel[Rel$Segment == 2,],aes(x= Dens,y = Hourly_Flow, color= Quantiles, label = DateTime))+
  geom_point()+
  facet_grid(~Delay_type, scales = 'free')+
  scale_y_continuous(minor_breaks = seq(0, 4000,50), breaks = seq(0,4000,100))+
  scale_x_continuous(minor_breaks = seq(0,500,5), breaks = seq(0,500,10))+
...
```{r Density vs Flow binned data seg2, fig.width = 11,echo = FALSE, message = FALSE}

tt <- ggplot(data=Rel_bin[Rel_bin$Segment == 2,],aes(x= Density_bin,y = Flow, color= quantiles))+
  geom_point()+
  # geom_smooth(span=0.75,se=F)+
  facet_grid(~Delay_type, scales = 'free')+
  scale_y_continuous(minor_breaks = seq(0, 4000,50), breaks = seq(0,4000,100))+
...
tt <- ggplot(data=Rel_bin[Rel_bin$Segment == 3,],aes(x= Density_bin,y = Flow, color= quantiles))+
  geom_point()+
  geom_smooth(span=0.75,se=F)+
  facet_grid(~Delay_type, scales = 'free')+
  ggtitle('Segment 3')
...
tt <- ggplot(data=Rel_bin[Rel_bin$Segment == 4,],aes(x= Density_bin,y = Flow, color= quantiles))+
  geom_point()+
  geom_smooth(span=0.75,se=F)+
  facet_grid(~Delay_type, scales = 'free')+
  ggtitle('Segment 4')
...
tt <- ggplot(data=Rel_bin[Rel_bin$Segment == 5,],aes(x= Density_bin,y = Flow, color= quantiles))+
  geom_point()+
  geom_smooth(span=0.75,se=F)+
  facet_grid(~Delay_type, scales = 'free')+
  ggtitle('Segment 5')
...
tt <- ggplot(data=Rel_bin[Rel_bin$Segment == 6,],aes(x= Density_bin,y = Flow, color= quantiles))+
  geom_point()+
  geom_smooth(span=0.75,se=F)+
  facet_grid(~Delay_type, scales = 'free')+
  ggtitle('Segment 6')
...
tt <- ggplot(data=Rel_bin[Rel_bin$Segment == 7,],aes(x= Density_bin,y = Flow, color= quantiles))+
  geom_point()+
  geom_smooth(span=0.75,se=F)+
  facet_grid(~Delay_type, scales = 'free')+
  ggtitle('Segment 7')
...
tt <- ggplot(data=Rel[Rel$Segment == 8,],aes(x= Dens,y = Hourly_Flow, color= Quantiles))+
  geom_point()+
  # geom_smooth(span=0.75,se=F)+
  facet_grid(~Delay_type, scales = 'free')+
  ggtitle('Segment 8')
...
tt <- ggplot(data=Rel_bin[Rel_bin$Segment == 8,],aes(x= Density_bin,y = Flow, color= quantiles))+
  geom_point()+
  geom_smooth(span=0.75,se=F)+
  facet_grid(~Delay_type, scales = 'free')+
  ggtitle('Segment 8')
...
tt <- ggplot(data=Rel[Rel$Segment == 9,],aes(x= Dens,y = Hourly_Flow, color= Quantiles))+
  geom_point()+
  # geom_smooth(span=0.75,se=F)+
  facet_grid(~Delay_type, scales = 'free')+
  ggtitle('Segment 9')
...
tt <- ggplot(data=Rel_bin[Rel_bin$Segment == 9,],aes(x= Density_bin,y = Flow, color= quantiles))+
  geom_point()+
  geom_smooth(span=0.75,se=F)+
  facet_grid(~Delay_type, scales = 'free')+
  ggtitle('Segment 9')
...
```{r find congestion points freeway, echo=FALSE}

model_crash <- Rel_bin[Rel_bin$Segment ==1,] %>%
...
model_none <- Rel_bin[Rel_bin$Segment ==1,]  %>%
...
model_weather <- Rel_bin[Rel_bin$Segment ==1,]  %>%
  filter(Delay_type != 'Weather') %>%
  nest(-Delay_type,-quantiles) %>%
  # as.tibble() %>%
  mutate(fit = map(data, ~ loess(Flow ~ Density_bin, span = 1, data = .,)),
         results = map(fit, augment)) %>%
...
sample_data <- Rel %>%
  filter(Delay_type == 'None',
         Quantiles == '55%',
         Segment == 2) %>%
  select(Dens, Hourly_Flow)
print(plot(sample_data))
```
