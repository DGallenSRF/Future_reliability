...
Rel_bin <- Rel_bin %>%
  filter(!(Segment == 2 & Delay_type == 'Weather' & Density_bin > 101)) %>%
  filter(!(Segment == 2 & Delay_type == 'Crash' & Density_bin > 125))
...
Rel_bin <- Rel_bin %>%
  filter(!(Segment == 3 & Delay_type == 'Weather' & Density_bin > 99)) %>%
  filter(!(Segment == 3 & Delay_type == 'Crash' & Density_bin > 151)) %>%
  filter(!(Segment == 3 & Delay_type == 'None' & Density_bin > 151))
...
Rel_bin <- Rel_bin %>%
  filter(!(Segment == 4 & Delay_type == 'Weather' & Density_bin == 50)) %>%
  filter(!(Segment == 4 & Delay_type == 'Weather' & Density_bin > 60)) %>%
  filter(!(Segment == 4 & Delay_type == 'Crash' & Density_bin == 50)) %>%
  filter(!(Segment == 4 & Delay_type == 'None' & Density_bin > 101))
...
dens_flow_plot(6,'none', bin = TRUE)
```
...
Rel_bin <- Rel_bin %>%
  filter(!(Segment == 7 & Delay_type == 'Weather' & Density_bin > 51)) %>%
  filter(!(Segment == 7 & Delay_type == 'Crash' & Density_bin > 51)) %>%
  filter(!(Segment == 7 & Delay_type == 'None' & Density_bin > 51))
...
dens_flow_plot(9,'none', bin = TRUE)
```

```{r filter segment 9}

Rel_bin <- Rel_bin %>%
  filter(!(Segment == 9 & Delay_type == 'Weather' & Density_bin > 100)) %>%
  filter(!(Segment == 9 & Delay_type == 'Weather' & Density_bin == 38)) %>%
  filter(!(Segment == 9 & Delay_type == 'Crash' & Density_bin > 38)) %>%
  filter(!(Segment == 9 & Delay_type == 'None' & Density_bin > 75))
...
sample_data <- Rel_bin %>%
  filter(Segment == 1, Delay_type == 'None', quantiles == '25%', !is.na(DC)) %>%
  select(DC, TTI)
```
